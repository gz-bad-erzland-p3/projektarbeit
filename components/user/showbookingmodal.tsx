...
export default function ShowBookingModal(props :any) {
              ...
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900">
                    Buchung vom {props.booking.Startdatum} bis zum {props.booking.Enddatum}
                  </Dialog.Title>
                  <div className="mt-2">
                    <BookingList booking={props.booking}></BookingList>
                  </div>
                </div>
              </div>

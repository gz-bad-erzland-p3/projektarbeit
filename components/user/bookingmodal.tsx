                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Wollen Sie die Buchung vom {props.booking.Startdatum} um {props.booking.Startzeit} bis <br /> {props.booking.Enddatum} um {props.booking.Endzeit} wirklich stornieren? <br /> Die Stornierungsgebühr beträgt 20% vom Buchungspreis.
                    </p>
                  </div>
                </div>
              </div>
